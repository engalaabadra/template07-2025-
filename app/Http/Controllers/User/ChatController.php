...
class ChatController extends BaseController
{
     ...
     * Dependency Injection for Chat model, ChatService, and GeneralService.
     *
     * @param Chat $chat
     * @param ChatService $chatService
     * @param GeneralService $generalService
     */
    public function __construct(Chat $chat, ChatService $chatService, GeneralService $generalService)
    {
        $this->chat = $chat;
    ...
    {
        $result = $this->chatService->deleteFiles($id, $this->chat);
        return $this->respond($result);
    }
